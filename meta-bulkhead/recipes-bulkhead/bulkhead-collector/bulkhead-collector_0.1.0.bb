...
# Pinned to bd7cfc5: completes the input-classification family started by b022155 (below), from the
...
# gain math now folds in the inheritable set (the inheritable+fcaps escalation was unflagged). Both
...
SRCREV = "bd7cfc53786b2ecab31fb7546f7c2ea0f88e5c12"
S = "${WORKDIR}/git"
