...
Relates to: ADR-0031 (substrate gives isolation, not egress), ADR-0035 (egress is the network half of action authorization), ADR-0036 (routing relies on this egress boundary); refines the egress line of ADR-0006/0009/0010.
