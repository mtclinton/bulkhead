...
1. **Resource authorization at the OS is the product.** Every syscall, network, and file action the agent takes is mediated **default-deny** behind the isolation substrate. This is a genuine OS-level guarantee.
